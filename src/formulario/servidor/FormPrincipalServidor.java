 ...
 * @author Alex
 */
public class FormPrincipalServidor extends javax.swing.JFrame {

    /**
     * Creates new form FormPrincipal
     */
    public FormPrincipalServidor() {
        configVentana();
        initComponents();
        pintarIconos();
    ...
    private void initComponents() {
        ...
        lblSistemaNombre.setText(Constantes.EMPRESA + " - Servidor");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormPrincipalServidor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormPrincipalServidor vistaPrincipal = new FormPrincipalServidor();
                ...
                new Thread( () -> {
                    ...
                    con.inicializarProps();
                    
                    java.awt.EventQueue.invokeLater(() -> {
                        //Controlador para el menú de opciones y la vista correspondiente a los menu
                        ControladorMenuServidor ctrlMenu = new ControladorMenuServidor(vistaPrincipal);
                    });
